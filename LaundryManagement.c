...
void tambahPelangganDanSimpan(Pelanggan pelanggan[], int *jumlah_pelanggan) {
    printf(WARNA_PATMA"Masukkan nama: "WARNA_SIAN);
    scanf(" %[^\n]s", pelanggan[*jumlah_pelanggan].nama);
    printf(WARNA_PATMA"Masukkan alamat: "WARNA_SIAN);
    scanf(" %[^\n]s", pelanggan[*jumlah_pelanggan].alamat);
    printf(WARNA_PATMA"Masukkan nomor telepon: "WARNA_SIAN);
...
void pesanLaundryDanSimpan(Pelanggan pelanggan[], int jumlah_pelanggan, Pesanan pesanan[], int *jumlah_pesanan) {
    int id_pelanggan, i;
    printf(WARNA_PATMA"Masukkan ID pelanggan: "WARNA_SIAN);
    scanf("%d", &id_pelanggan);

    for (i = 0; i < jumlah_pelanggan; i++) {
        if (pelanggan[i].id == id_pelanggan) {
            printf(WARNA_HIJAU"\nPilihan Jenis Cucian:\n"WARNA_RESET);
            printf(WARNA_MERAH"1. Baju saja\n");
            printf("2. Celana Saja\n");
            printf("3. Baju dan Celana\n");
            printf("4. Sepatu\n");
            printf("5. Selimut\n");
            printf("6. Tas\n");
            printf("7. Kaos Kaki\n");
            printf("8. Sarung Tangan\n");
            printf("9. Topi\n"WARNA_RESET);
            printf(WARNA_PATMA"Pilih jenis cucian (1-9): "WARNA_SIAN);
            int pilihan_cucian;
            ...
            printf(WARNA_PATMA"Masukkan jumlah cucian: "WARNA_SIAN);
    ...
    while (fgets(buffer, sizeof(buffer), file) != NULL) {
        ...
        if (flag_pesanan) {
            ...
            if (sscanf(buffer, "%d,%19[^,],%d,%f,%d", &id_pelanggan, jenis_cucian,
                ...
                if (status_selesai == 0) {
                    printf(WARNA_SIAN"ID Pelanggan: %d, Jenis Cucian: %s, Jumlah: %d, Total Biaya: %.0f\n"WARNA_RESET,
...
void pesananSelesai(Pesanan pesanan[], int jumlah_pesanan, Pelanggan pelanggan[], int jumlah_pelanggan) {
    int id_pesanan;
    printf(WARNA_PATMA"Masukkan ID pesanan yang sudah selesai: "WARNA_SIAN);
    scanf("%d", &id_pesanan);
...
// Fungsi untuk menukar data pesanan dengan metode Bubble Sort
...
int main() {
    ...
    do {
        ...
        printf("\t\t\t|| 7. Urut Pesanan berdasarkan total biaya  ||\n");
        printf("\t\t\t|| 8. Keluar                                ||\n");
        printf("\t\t\t==============================================\n");
        printf("\t\t\t||" WARNA_MERAH "    Dibuat Oleh : Fattan Naufan Islami    " WARNA_SIAN "||\n");
        printf("\t\t\t==============================================\n"WARNA_RESET);
        printf("\t\t\t\t");
        ...
        switch (pilihan) {
            ...
            case 6: {
                ...
                system("cls");
                JudulCariPelanggan();
                printf(WARNA_PATMA"Masukkan ID pelanggan yang dicari: "WARNA_SIAN);
                scanf("%d", &idDicari);
            ...
            case 7:
                ...
                DelayPrintExit("Pesanan berhasil diurutkan berdasarkan total biaya...", 50);
                system("cls");
                break;
            case 8:
                system("cls");
